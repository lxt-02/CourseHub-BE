...
@Service
public record GetCategoryByIdUseCase(CategoryUseCaseHandler CategoryUseCaseHandler) {

    public ApiResponse<CategoryResponse> execute(UUID id) {
        return ApiResponse.success("Category fetched successfully", CategoryUseCaseHandler.getById(id));
    }
}
